...
def main(args):
    ...
    for i in range(args.examples):
        position_1 = np.random.randint(0, args.sequence_length-3)
        position_2 = np.random.randint(position_1+1, args.sequence_length-2)
        position_3 = np.random.randint(position_2+1, args.sequence_length)

        for position in range(position_1, position_2):
            X_train[i,0,position,0] = 1
            X_train[i,0,position,1] = 0
    ...
    for i in range(args.examples//10):
        ...
        for position in range(position_1, position_2):
            X_test[i,0,position,0] = 1
            X_test[i,0,position,1] = 0
