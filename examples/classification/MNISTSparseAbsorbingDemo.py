...
tm = TMClassifier(2000, 5000, 10.0, platform='CPU_sparse', weighted_clauses=True, literal_sampling = 0.1, max_included_literals=32, feedback_rate_excluded_literals=1, absorbing=100, literal_insertion_state=-1)
